...
// For tests generated by this file, do not run tests with `with-extensions`
Boolean includeCExtensions = false

def getPacknsendTests (String workspace, String testSuffix, String mostRecentOnly,
        Boolean includeCExtensions) {
    ...
    def proc = (
        "python2.7 ${workspace}/jenkins/scripts/parse_integration_test_tox_files.py " +
            ...
            "--workspace ${workspace} " +
            "--include-cext ${includeCExtensions}"
    )
