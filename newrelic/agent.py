...
from newrelic.api.ml_model import record_ai_feedback_event as __record_ai_feedback_event
...
record_ai_feedback_event = __wrap_api_call(__record_ai_feedback_event, "record_ai_feedback_event")
