...
def _process_module_builtin_defaults():
    ...
    _process_module_definition("grpc.aio._server", "newrelic.hooks.framework_grpcaio", "instrument_grpc_aio_server")
    _process_module_definition("grpc.aio._channel", "newrelic.hooks.framework_grpcaio", "instrument_grpc_aio_channel")
