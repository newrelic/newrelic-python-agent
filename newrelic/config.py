...
def _process_configuration(section):
    ...
    _process_setting(section, "security.skip_iast_scan.api", "get", _map_inc_excl_attributes)
    _process_setting(section, "security.skip_iast_scan.parameters.header", "get", _map_inc_excl_attributes)
    _process_setting(section, "security.skip_iast_scan.parameters.query", "get", _map_inc_excl_attributes)
    _process_setting(section, "security.skip_iast_scan.parameters.body", "get", _map_inc_excl_attributes)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.insecure_settings", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.invalid_file_access", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.sql_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.nosql_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.ldap_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.javascript_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.command_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.xpath_injection", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.ssrf", "getboolean", None)
    _process_setting(section, "security.skip_iast_scan.iast_detection_category.rxss", "getboolean", None)
