...
class CaptureDependenciesSettings(Settings):
    pass
...
_settings.capture_dependencies = CaptureDependenciesSettings()
...
_settings.capture_dependencies.enabled = _environ_as_bool("NEW_RELIC_CAPTURE_DEPENDENCIES_ENABLED", default=True)
