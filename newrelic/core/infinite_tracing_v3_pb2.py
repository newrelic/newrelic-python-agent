...
try:
    ...
    _SPAN_INTRINSICSENTRY = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="key",
                full_name="com.newrelic.trace.v1.Span.IntrinsicsEntry.key",
                index=0,
                number=1,
                type=9,
                cpp_type=9,
            ...
            _descriptor.FieldDescriptor(
                name="value",
                full_name="com.newrelic.trace.v1.Span.IntrinsicsEntry.value",
                index=1,
                number=2,
                type=11,
                cpp_type=10,
    ...
    _SPAN_USERATTRIBUTESENTRY = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="key",
                full_name="com.newrelic.trace.v1.Span.UserAttributesEntry.key",
                index=0,
                number=1,
                type=9,
                cpp_type=9,
            ...
            _descriptor.FieldDescriptor(
                name="value",
                full_name="com.newrelic.trace.v1.Span.UserAttributesEntry.value",
                index=1,
                number=2,
                type=11,
                cpp_type=10,
    ...
    _SPAN_AGENTATTRIBUTESENTRY = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="key",
                full_name="com.newrelic.trace.v1.Span.AgentAttributesEntry.key",
                index=0,
                number=1,
                type=9,
                cpp_type=9,
            ...
            _descriptor.FieldDescriptor(
                name="value",
                full_name="com.newrelic.trace.v1.Span.AgentAttributesEntry.value",
                index=1,
                number=2,
                type=11,
                cpp_type=10,
    ...
    _SPAN = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="trace_id",
                full_name="com.newrelic.trace.v1.Span.trace_id",
                index=0,
                number=1,
                type=9,
                cpp_type=9,
            ...
            _descriptor.FieldDescriptor(
                name="intrinsics",
                full_name="com.newrelic.trace.v1.Span.intrinsics",
                index=1,
                number=2,
                type=11,
                cpp_type=10,
            ...
            _descriptor.FieldDescriptor(
                ...
                full_name="com.newrelic.trace.v1.Span.user_attributes",
                index=2,
                number=3,
                type=11,
                cpp_type=10,
            ...
            _descriptor.FieldDescriptor(
                ...
                full_name="com.newrelic.trace.v1.Span.agent_attributes",
                index=3,
                number=4,
                type=11,
                cpp_type=10,
        ...
        extensions=[],
        nested_types=[
            _SPAN_INTRINSICSENTRY,
            _SPAN_USERATTRIBUTESENTRY,
            _SPAN_AGENTATTRIBUTESENTRY,
        ],
        enum_types=[],
        serialized_options=None,
        is_extendable=False,
    ...
    _ATTRIBUTEVALUE = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="string_value",
                full_name="com.newrelic.trace.v1.AttributeValue.string_value",
                index=0,
                number=1,
                type=9,
                cpp_type=9,
            ...
            _descriptor.FieldDescriptor(
                name="bool_value",
                full_name="com.newrelic.trace.v1.AttributeValue.bool_value",
                index=1,
                number=2,
                type=8,
                cpp_type=7,
            ...
            _descriptor.FieldDescriptor(
                name="int_value",
                full_name="com.newrelic.trace.v1.AttributeValue.int_value",
                index=2,
                number=3,
                type=3,
                cpp_type=2,
            ...
            _descriptor.FieldDescriptor(
                name="double_value",
                full_name="com.newrelic.trace.v1.AttributeValue.double_value",
                index=3,
                number=4,
                type=1,
                cpp_type=5,
        ...
        oneofs=[
            _descriptor.OneofDescriptor(
                name="value",
                full_name="com.newrelic.trace.v1.AttributeValue.value",
                index=0,
                containing_type=None,
                fields=[],
            ),
    ...
    _RECORDSTATUS = _descriptor.Descriptor(
        ...
        fields=[
            _descriptor.FieldDescriptor(
                name="messages_seen",
                full_name="com.newrelic.trace.v1.RecordStatus.messages_seen",
                index=0,
                number=1,
                type=4,
                cpp_type=4,
    ...
    _ATTRIBUTEVALUE.oneofs_by_name["value"].fields.append(_ATTRIBUTEVALUE.fields_by_name["string_value"])
    _ATTRIBUTEVALUE.fields_by_name["string_value"].containing_oneof = _ATTRIBUTEVALUE.oneofs_by_name["value"]
    _ATTRIBUTEVALUE.oneofs_by_name["value"].fields.append(_ATTRIBUTEVALUE.fields_by_name["bool_value"])
    ...
    _ATTRIBUTEVALUE.oneofs_by_name["value"].fields.append(_ATTRIBUTEVALUE.fields_by_name["double_value"])
