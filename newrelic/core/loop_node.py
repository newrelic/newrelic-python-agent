...
class LoopNode(_LoopNode, GenericNodeMixin):
    ...
    def time_metrics(self, stats, root, parent):
        ...
        if root.type == "WebTransaction":
            yield TimeMetric(name=name + "Web", scope="", duration=self.duration, exclusive=None)
        else:
            yield TimeMetric(name=name + "Other", scope="", duration=self.duration, exclusive=None)
