...
import newrelic.core.otlp_trace_pb2 as opentelemetry_dot_proto_dot_trace_dot_v1_dot_trace__pb2
...
_EXPORTTRACESERVICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resource_spans",
            full_name="opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest.resource_spans",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_EXPORTTRACESERVICEREQUEST.fields_by_name[
    "resource_spans"
