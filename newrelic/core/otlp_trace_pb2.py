...
from newrelic.core import (
    otlp_common_pb2 as opentelemetry_dot_proto_dot_common_dot_v1_dot_common__pb2,
)
from newrelic.core import (
    otlp_resource_pb2 as opentelemetry_dot_proto_dot_resource_dot_v1_dot_resource__pb2,
)
