...
class SamplerProxy:
    def __init__(self, settings):
        ...
        self.add_adaptive_sampler((True, 1), settings.distributed_tracing.full_granularity.remote_parent_sampled.adaptive.sampling_target, sampling_target_period)
        self.add_adaptive_sampler((True, 2), settings.distributed_tracing.full_granularity.remote_parent_not_sampled.adaptive.sampling_target, sampling_target_period)
        self.add_adaptive_sampler((False, 1), settings.distributed_tracing.partial_granularity.remote_parent_sampled.adaptive.sampling_target, sampling_target_period)
        self.add_adaptive_sampler((False, 2), settings.distributed_tracing.partial_granularity.remote_parent_not_sampled.adaptive.sampling_target, sampling_target_period)
