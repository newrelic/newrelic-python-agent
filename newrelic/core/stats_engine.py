            ...
            if settings.infinite_tracing.enabled:
                ...
                if transaction.partial_granularity_sampled:
                    ...
                    self.record_custom_metrics([
                        (f"Supportability/DistributedTrace/PartialGranularity/{partial_gran_type}/Span/Instrumented", {"count": transaction.instrumented})
                        (f"Supportability/DistributedTrace/PartialGranularity/{partial_gran_type}/Span/Kept", {"count": transaction.kept})
                    ])
