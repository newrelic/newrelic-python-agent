...
class TransactionNode(_TransactionNode):
    ...
    def span_events(self, settings, attr_class=dict):
        ...
        ct_exit_spans = {}
        yield from self.root.span_events(settings, base_attrs, parent_guid=self.parent_span, attr_class=attr_class, partial_granularity_sampled = self.partial_granularity_sampled, ct_exit_spans=ct_exit_spans)
