...
def _bind_connect(dsn=None, connection_factory=None, cursor_factory=None, *args, **kwargs):
    return bool(connection_factory or cursor_factory)


def _bind_cursor(name=None, cursor_factory=None, scrollable=None, withhold=False, *args, **kwargs):
