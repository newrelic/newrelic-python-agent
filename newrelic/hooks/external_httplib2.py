...
def _nr_wrapper_httplib2_endheaders_wrapper(*library_info):
    def _nr_wrapper_httplib2_endheaders_wrapper_inner(wrapped, instance, args, kwargs):
...
def instrument(module):
    wrap_function_wrapper(
        module, "HTTPConnectionWithTimeout.endheaders", _nr_wrapper_httplib2_endheaders_wrapper("httplib2", "http")
    )

    wrap_function_wrapper(
        module, "HTTPSConnectionWithTimeout.endheaders", _nr_wrapper_httplib2_endheaders_wrapper("httplib2", "https")
    )
