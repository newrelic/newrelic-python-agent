...
def _record_embedding_error(transaction, embedding_id, linking_metadata, kwargs, ft, exc):
    ...
    try:
        ...
        if prompt_tokens:
            error_embedding_dict["response.usage.prompt_tokens"] = prompt_tokens
            error_embedding_dict["response.usage.total_tokens"] = prompt_tokens
...
def _record_embedding_success(transaction, embedding_id, linking_metadata, kwargs, ft):
    ...
    try:
        ...
        if prompt_tokens:
            full_embedding_response_dict["response.usage.prompt_tokens"] = prompt_tokens
            full_embedding_response_dict["response.usage.total_tokens"] = prompt_tokens
...
def _record_generation_error(transaction, settings, linking_metadata, completion_id, kwargs, ft, exc):
    ...
    try:
        ...
        if prompt_tokens:
            error_chat_completion_dict["response.usage.prompt_tokens"] = prompt_tokens
            ...
            error_chat_completion_dict["response.usage.total_tokens"] = prompt_tokens
