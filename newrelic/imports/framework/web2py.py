...
def instrument_gluon_compileapp(module):
    ...
    wrap_function_trace(module, 'run_models_in',
    ...
    wrap_function_trace(module, 'run_controller_in',
    ...
    wrap_function_trace(module, 'run_view_in',
...
def instrument_gluon_restricted(module):
    ...
    wrap_function_trace(module, 'restricted',
...
def instrument_gluon_main(module):
    ...
    class error_serve_controller(ObjectWrapper):
...
def instrument_gluon_template(module):
    ...
    wrap_function_trace(module, 'parse_template',
...
def instrument_gluon_tools(module):
    ...
    wrap_external_trace(module, 'fetch', library='gluon.tools.fetch',
    ...
    wrap_external_trace(module, 'geocode', library='gluon.tools.geocode',
...
def instrument_gluon_http(module):
    ...
    wrap_pre_function(module, 'HTTP.to', name_transaction_name_not_found)
