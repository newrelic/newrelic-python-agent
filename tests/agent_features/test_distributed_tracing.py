...
@pytest.mark.parametrize(
    ...
    (
        (True, 'default', 'default', True, None, True),  # Uses sampling algo.
        ...
        (True, 'default', 'always_on', True, None, True),  # Uses sampling algo.
        (True, 'default', 'always_off', True, None, True),  # Uses sampling algo.
