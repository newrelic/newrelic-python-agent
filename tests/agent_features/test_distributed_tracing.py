...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(traceparent=False, tracestate=False, newrelic=False, metrics=NO_HEADERS_ACCEPTED, id="no_headers"),
        pytest.param(
            traceparent=False, tracestate=False, newrelic=True, metrics=NEW_RELIC_ACCEPTED, id="newrelic_only"
        ),
        pytest.param(
            traceparent=False, tracestate=True, newrelic=True, metrics=NEW_RELIC_ACCEPTED, id="tracestate_and_newrelic"
        ),
        pytest.param(
            traceparent=False, tracestate=True, newrelic=False, metrics=NO_HEADERS_ACCEPTED, id="tracestate_only"
        ),
        pytest.param(
            traceparent=True, tracestate=True, newrelic=True, metrics=TRACE_CONTEXT_ACCEPTED, id="all_headers"
        ),
        pytest.param(
            traceparent=True, tracestate=False, newrelic=False, metrics=TRACE_CONTEXT_ACCEPTED, id="traceparent_only"
        ),
        pytest.param(
            traceparent=True,
            tracestate=False,
            newrelic=True,
            metrics=TRACE_CONTEXT_ACCEPTED,
            id="traceparent_and_newrelic",
        ),
        pytest.param(
            traceparent=True,
            tracestate=True,
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            newrelic_header=False,
            traceparent_sampled=None,
            newrelic_sampled=None,
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            expected_sampled=None,
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="root_adaptive",
        ),
        pytest.param(
            newrelic_header=False,
            traceparent_sampled=None,
            newrelic_sampled=None,
            root_setting="always_on",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            expected_sampled=True,
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="root_always_on",
        ),
        pytest.param(
            newrelic_header=False,
        ...
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            newrelic_sampled=None,
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            ...
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_sampled_adaptive",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            newrelic_sampled=None,
            root_setting="default",
            remote_parent_sampled_setting="always_on",
            remote_parent_not_sampled_setting="default",
            expected_sampled=True,
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="traceparent_sampled_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            newrelic_sampled=None,
            root_setting="default",
            remote_parent_sampled_setting="always_off",
            remote_parent_not_sampled_setting="default",
            expected_sampled=False,
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="traceparent_sampled_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            newrelic_sampled=None,
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            ...
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_not_sampled_adaptive",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_not_sampled_always_on_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_not_sampled_always_off_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            ...
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="always_on",
            expected_sampled=None,
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_sampled_not_sampled_always_on_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            ...
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="always_off",
            expected_sampled=None,
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="traceparent_sampled_not_sampled_always_off_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="traceparent_not_sampled_not_sampled_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="traceparent_not_sampled_not_sampled_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            newrelic_sampled=True,
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            expected_sampled=True,
            expected_priority=1.23456,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_sampled_true",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            newrelic_sampled=False,
            root_setting="default",
            remote_parent_sampled_setting="default",
            remote_parent_not_sampled_setting="default",
            expected_sampled=False,
            expected_priority=1.23456,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_sampled_false",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=1.23456,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_not_sampled_false",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            ...
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_false_override_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=True,
            ...
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_true_override_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_not_sampled_override_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=False,
            ...
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="w3c_tracestate_not_sampled_override_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            remote_parent_not_sampled_setting="default",
            expected_sampled=True,
            expected_priority=0.1234,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_true",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_true_override_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_true_override_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=0.1234,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_false",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=0.1234,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_false_override_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=0.1234,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_true_not_sampled_ignored",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_false_override_not_sampled_always_on",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=0,
            expected_adaptive_sampling_algo_called=False,
            id="newrelic_header_sampled_false_override_not_sampled_always_off",
        ),
        pytest.param(
            newrelic_header=True,
            traceparent_sampled=None,
            ...
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="newrelic_header_no_sampling_adaptive",
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            full_granularity_enabled=True,
            full_granularity_remote_parent_sampled_setting="always_off",
            partial_granularity_enabled=True,
            partial_granularity_remote_parent_sampled_setting="adaptive",
            expected_sampled=None,
            expected_priority=None,
            expected_adaptive_sampling_algo_called=True,
            id="full_off_partial_adaptive",
        ),
        pytest.param(
            full_granularity_enabled=True,
            full_granularity_remote_parent_sampled_setting="always_on",
            partial_granularity_enabled=True,
            partial_granularity_remote_parent_sampled_setting="adaptive",
            expected_sampled=True,
            expected_priority=3,
            expected_adaptive_sampling_algo_called=False,
            id="full_on_partial_adaptive",
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            ...
            dt_headers={},
            expected_sampling_instance_called=(False, 0),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=5,
            id="partial_root_target_5",
        ),
        pytest.param(
            dt_settings={
                "distributed_tracing.sampler.full_granularity.enabled": False,
            ...
            dt_headers={"traceparent": "00-0af7651916cd43dd8448eb211c80319c-00f067aa0ba902b7-01"},
            expected_sampling_instance_called=(False, 1),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=5,
            id="partial_remote_sampled_target_5",
        ),
        pytest.param(
            dt_settings={
                "distributed_tracing.sampler.full_granularity.enabled": False,
            ...
            dt_headers={"traceparent": "00-0af7651916cd43dd8448eb211c80319c-00f067aa0ba902b7-00"},
            expected_sampling_instance_called=(False, 2),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=6,
            id="partial_remote_not_sampled_target_6",
        ),
        pytest.param(
            dt_settings={
            ...
            dt_headers={},
            expected_sampling_instance_called=(True, 0),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=5,
            id="full_root_target_5",
        ),
        pytest.param(
            dt_settings={
                "distributed_tracing.sampler.full_granularity.enabled": True,
            ...
            dt_headers={"traceparent": "00-0af7651916cd43dd8448eb211c80319c-00f067aa0ba902b7-01"},
            expected_sampling_instance_called=(True, 1),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=5,
            id="full_remote_sampled_target_5",
        ),
        pytest.param(
            dt_settings={
                "distributed_tracing.sampler.full_granularity.enabled": True,
            ...
            dt_headers={"traceparent": "00-0af7651916cd43dd8448eb211c80319c-00f067aa0ba902b7-00"},
            expected_sampling_instance_called=(True, 2),
            expected_adaptive_computed_count=1,
            expected_adaptive_sampled_count=1,
            expected_adaptive_sampling_target=6,
            id="full_remote_not_sampled_target_6",
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            ...
            expected_priority=0.123,
            expected_sampled=False,
            id="dt_enabled_samplers_disabled",
        ),
        pytest.param(
            dt_settings={"distributed_tracing.enabled": False},
            expected_priority=0.123,
            expected_sampled=False,
            id="dt_disabled",
        ),
        pytest.param(
            dt_settings={"distributed_tracing.sampler.root.trace_id_ratio_based.ratio": 1},
            expected_priority=2.123,
            expected_sampled=True,
            id="full_granularity_sampled_priority_plus_2",
        ),
        pytest.param(
            dt_settings={
                "distributed_tracing.sampler.full_granularity.enabled": False,
            ...
            expected_priority=1.123,
            expected_sampled=True,
            id="partial_granularity_sampled_priority_plus_1",
        ),
    ),
)
