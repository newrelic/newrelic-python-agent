...
_test_function_trace_valid_override_scoped_metrics = [("Custom/FunctionTrace", 1)]
...
_test_function_trace_empty_group_scoped_metrics = [("Function/FunctionTrace", 1)]
...
_test_function_trace_leading_slash_on_group_scoped_metrics = [("Function/Group/FunctionTrace", 1)]
