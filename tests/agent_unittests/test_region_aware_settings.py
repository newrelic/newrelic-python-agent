...
@pytest.mark.parametrize(
    "ini,env,expected_host,expected_license_key",
    [
...
def test_region_aware_license_keys(ini, env, expected_host, expected_license_key, global_settings):
...
@pytest.mark.parametrize(
    "ini,license_key,host_override,expected_host",
    (
...
def test_region_aware_global_settings(ini, license_key, host_override, expected_host, global_settings):
    settings = global_settings()
