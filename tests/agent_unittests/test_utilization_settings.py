...
ENV_WITH_HEROKU = {
    "NEW_RELIC_HEROKU_USE_DYNO_NAMES": "false",
...
@pytest.mark.parametrize("server_settings", _server_side_config_settings_util_conf)
...
def test_finalize_application_settings(server_settings):
    ...
    finalize_application_settings(server_side_config=server_settings, settings=settings)
