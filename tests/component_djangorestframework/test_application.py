...
_scoped_metrics = [
    ...
    (("Function/django.middleware.common:" "CommonMiddleware" + process_request_method), None),
    ...
    (("Function/django.contrib.messages.middleware:" "MessageMiddleware" + process_request_method), None),
    (("Function/%s:" % url_module_path + "%s.resolve" % url_resolver_cls), 1),
    (("Function/django.middleware.csrf:" "CsrfViewMiddleware" + process_view_method), None),
    (("Function/django.contrib.messages.middleware:" "MessageMiddleware" + process_response_method), None),
    (("Function/django.middleware.csrf:" "CsrfViewMiddleware" + process_response_method), None),
    (("Function/django.contrib.sessions.middleware:" "SessionMiddleware" + process_response_method), 1),
    (("Function/django.middleware.common:" "CommonMiddleware" + process_response_method), None),
]
...
if DJANGO_VERSION >= (1, 5):
    _test_application_view_scoped_metrics.extend([("Function/rest_framework.response:Response.close", 1)])


@validate_transaction_errors(errors=[])
@validate_transaction_metrics("urls:View.get", scoped_metrics=_test_application_view_scoped_metrics)
...
_test_application_view_error_scoped_metrics.append(("Function/urls:ViewError.get", 1))


@validate_transaction_errors(errors=["urls:Error"])
@validate_transaction_metrics("urls:ViewError.get", scoped_metrics=_test_application_view_error_scoped_metrics)
...
_test_application_view_handle_error_scoped_metrics.append(("Function/urls:ViewHandleError.get", 1))
...
def test_application_view_handle_error(status, should_record, use_global_exc_handler, target_application):
...
@validate_transaction_metrics(_test_api_view_view_name_post, scoped_metrics=_test_api_view_scoped_metrics_post)
