...
@validate_code_level_metrics(
    "_test_application.create_app.<locals>", "IndexResource", py2_namespace="_test_application"
)
...
def test_application_raises(exception, status_code, ignore_status_code, propagate_exceptions, application):
    @validate_code_level_metrics(
        "_test_application.create_app.<locals>", "ExceptionResource", py2_namespace="_test_application"
    )
