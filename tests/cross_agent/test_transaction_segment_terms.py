...
FIXTURE = Path(__file__).parent / "fixtures" / "transaction_segment_terms.json"
OUTBOUD_REQUESTS = {}
...
@pytest.mark.parametrize(_parameters, load_tests())
def test_transaction_freeze_path_segments(testname, transaction_segment_terms, tests):
