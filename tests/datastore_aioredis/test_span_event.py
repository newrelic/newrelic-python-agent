...
strict_redis_client = aioredis.StrictRedis(host=DB_SETTINGS['host'], port=DB_SETTINGS['port'], db=DATABASE_NUMBER)
redis_client = aioredis.Redis(host=DB_SETTINGS['host'], port=DB_SETTINGS['port'], db=DATABASE_NUMBER)
