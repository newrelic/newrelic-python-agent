...
from testing_support.fixture.event_loop import (  # noqa: 401 # pylint: disable=W0611
    event_loop as loop,
)
...
@background_task()
def test_trace_node_datastore_params_disable_instance(loop):  # noqa
    loop.run_until_complete(_exercise_db())
...
@background_task()
def test_trace_node_datastore_params_instance_only(loop):  # noqa
    loop.run_until_complete(_exercise_db())
...
@background_task()
def test_trace_node_datastore_params_database_only(loop):  # noqa
    loop.run_until_complete(_exercise_db())
