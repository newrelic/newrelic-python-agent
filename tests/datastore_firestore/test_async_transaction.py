...
def test_firestore_async_transaction_commit(loop, exercise_async_transaction_commit, async_collection):
...
def test_firestore_async_transaction_rollback(loop, exercise_async_transaction_rollback, async_collection):
    _test_scoped_metrics = [
