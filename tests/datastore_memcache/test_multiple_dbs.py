...
if len(DB_MULTIPLE_SETTINGS) > 1:
    ...
    instance_metric_name_1 = "Datastore/instance/Memcached/%s/%s" % (host_1, port_1)
    instance_metric_name_2 = "Datastore/instance/Memcached/%s/%s" % (host_2, port_2)
...
@validate_transaction_metrics(
    transaction_metric_prefix + "_enabled",
...
@validate_transaction_metrics(
    transaction_metric_prefix + "_disabled",
