...
def test_span_events(instance_enabled):
    ...
    @validate_span_events(
        count=1, exact_intrinsics=query_1, exact_agents=exact_agents, unexpected_agents=("db.instance",)
    )
    @validate_span_events(
        count=1, exact_intrinsics=query_2, exact_agents=exact_agents, unexpected_agents=("db.instance",)
    )
    @validate_span_events(
        count=1, exact_intrinsics=query_3, exact_agents=exact_agents, unexpected_agents=("db.instance",)
    )
