...
@validate_slow_sql_collector_json(required_params=_enabled_required, forgone_params=_enabled_forgone)
@background_task()
...
@validate_slow_sql_collector_json(required_params=_disabled_required, forgone_params=_disabled_forgone)
@background_task()
