...
def client():
    ...
    _client = OpenSearch(urls, selector_class=RoundRobinSelector, randomize_hosts=False)
...
def test_multi_get_enabled(client):
    _exercise_opensearch_multi(client)
