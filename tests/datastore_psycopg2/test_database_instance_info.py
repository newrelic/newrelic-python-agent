...
@pytest.mark.parametrize('connect_params,expected', [
    ...
    ((('postgresql://localhost:5433',), {}),
        ('localhost', None, '5433', None)),
    ((('postgresql://localhost/mydb',), {}),
        ('localhost', None, None, 'mydb')),
