...
# @validate_transaction_metrics('test_pymssql:test_execute_via_cursor',
...
# @validate_transaction_metrics(
#         'test_pymssql:test_execute_via_cursor_context_manager',
...
#     host = DB_SETTINGS['host'] + ":" + str(DB_SETTINGS['port'])
