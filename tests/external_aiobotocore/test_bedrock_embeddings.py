...
@background_task(name="test_bedrock_embedding")
def test_bedrock_embedding_error_malformed_request_body(loop, bedrock_server, set_trace_info):
    """
...
@background_task(name="test_bedrock_embedding")
def test_bedrock_embedding_error_malformed_response_body(loop, bedrock_server, set_trace_info):
    """
