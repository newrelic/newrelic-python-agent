...
BOTTLE_VERSION = get_package_version_tuple("bottle")

requires_auth_basic = pytest.mark.skipif(BOTTLE_VERSION < (0, 9, 0), reason="Bottle only added auth_basic in 0.9.0.")
requires_plugins = pytest.mark.skipif(BOTTLE_VERSION < (0, 9, 0), reason="Bottle only added auth_basic in 0.9.0.")
...
_test_application_index_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
...
_test_application_error_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
...
_test_application_not_found_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
...
_test_application_auth_basic_fail_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
...
_test_application_auth_basic_okay_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
...
_test_application_plugin_error_custom_metrics = [("Python/Framework/Bottle/%s.%s.%s" % BOTTLE_VERSION, 1)]
