...
_test_django_url_resolver_scoped_metrics = [
...
_test_application_index_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_application_not_found_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_application_cbv_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_application_deferred_cbv_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_application_inclusion_tag_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_inclusion_tag_template_tags_scoped_metrics.extend(_test_django_url_resolver_scoped_metrics)
...
_test_template_render_exception_scoped_metrics_base.extend(_test_django_url_resolver_scoped_metrics)
