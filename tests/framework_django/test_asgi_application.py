...
@pytest.mark.parametrize("url,view_name", (("/cbv", "views:MyView.get"), ("/deferred_cbv", "views:deferred_cbv")))
...
@pytest.mark.parametrize(
    "url", ("/html_insertion", "/html_insertion_content_length", "/template_tags", "/gzip_html_insertion")
)
@override_application_settings(
    {
...
@pytest.mark.parametrize(
    "url",
    ("/html_insertion_manual", "/html_insertion_unnamed_attachment_header", "/html_insertion_named_attachment_header"),
)
@override_application_settings(
    {
        "browser_monitoring.enabled": True,
