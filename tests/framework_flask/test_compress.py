...
@validate_transaction_metrics("_test_compress:index_page", scoped_metrics=_test_application_index_scoped_metrics)
...
def test_html_insertion_unnamed_attachment_header_flask_middleware():
    application = target_application()
    response = application.get("/html_insertion_unnamed_attachment_header", status=200)
...
def test_html_insertion_named_attachment_header_flask_middleware():
    application = target_application()
    response = application.get("/html_insertion_named_attachment_header", status=200)
...
def test_text_served_from_file():
    application = target_application()
    response = application.get("/text_served_from_file", status=200)
