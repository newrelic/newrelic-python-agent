...
from graphene import Schema, String, Union
from graphene_django import DjangoObjectType

from .models import Author as _Author
from .models import Book as _Book
from .models import Library as _Library
from .models import Magazine as _Magazine
...
class Book(DjangoObjectType):
    class Meta:
        model = _Book
        fields = ("id", "name", "isbn", "author", "branch")


class Magazine(DjangoObjectType):
    class Meta:
        model = _Magazine
        fields = ("id", "name", "issue", "branch")
...
class Library(DjangoObjectType):
    class Meta:
        model = _Library
        fields = ("id", "branch", "magazine", "book")
...
class Mutation(GrapheneObjectType):
