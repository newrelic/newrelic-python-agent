...
@validate_transaction_metrics(
    "_test_application:cornice_service_get_info", scoped_metrics=_test_cornice_service_scoped_metrics
)
...
@validate_transaction_errors(errors=[])
@validate_transaction_metrics(
    "_test_application:Resource.collection_get", scoped_metrics=_test_cornice_resource_collection_get_scoped_metrics
)
...
@validate_transaction_errors(errors=[])
@validate_transaction_metrics(
    "_test_application:Resource.get", scoped_metrics=_test_cornice_resource_get_scoped_metrics
)
...
@validate_transaction_metrics(
    "_test_application:cornice_error_get_info", scoped_metrics=_test_cornice_error_scoped_metrics
)
