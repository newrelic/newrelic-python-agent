...
# NOTE: This test file was copied from tests/framework_tornado_r3 verbatim
...
def remove_utilization_tester(now=True, queue=None):
    ...
    try:
        if now:
            ...
            # check that thread utilization is, in fact, added to
            # _data_sources, before tornado is imported and removes it.
