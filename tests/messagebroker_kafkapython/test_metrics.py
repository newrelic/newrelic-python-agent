...
def test_data_source_metrics(data_source, topic, producer, consumer):
    _data_source_metrics = {
        ...
        "MessageBroker/Kafka/Internal/consumer-fetch-manager-metrics/records-per-request-avg": "present",
        ...
        "MessageBroker/Kafka/Internal/consumer-fetch-manager-metrics/%s/records-per-request-avg" % topic: "present",
