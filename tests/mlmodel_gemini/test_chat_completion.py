...
# @validate_transaction_metrics(
#     "test_chat_completion:test_gemini_chat_completion_sync_stream_monitoring_disabled",
#     scoped_metrics=[("Llm/completion/Gemini/create", 1)],
#     rollup_metrics=[("Llm/completion/Gemini/create", 1)],
#     background_task=True,
# )
# @background_task()
# def test_gemini_chat_completion_sync_stream_monitoring_disabled(set_trace_info):
#     set_trace_info()

#     openai.ChatCompletion.create(
#         model="gemini-1.5-flash", messages=_test_gemini_chat_completion_messages, temperature=0.7, max_tokens=100
#     )
