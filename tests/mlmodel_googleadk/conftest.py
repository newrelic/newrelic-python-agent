...
# Though signatures can cause matching issues, and are better to remove.
VCR_MATCHERS["body"] = gemini_match_body_no_thought_signature
# These headers vary in existence by ADK version, but shouldn't be relevant to the actual recording
VCR_IGNORED_HEADERS.extend(["accept", "connection", "host"])
