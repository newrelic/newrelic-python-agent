...
# At the same time, ADK's v2.9+ fields a server sends that the SDK does not declare
# no longer reach the caller.  As a result, only one distinct error is counted.
