...
@background_task()
def test_pdf_pagesplitter_vectorstore_in_txn(set_trace_info, embeding_openai_client):
    set_trace_info()
...
def test_pdf_pagesplitter_vectorstore_outside_txn(set_trace_info, embeding_openai_client):
    set_trace_info()
