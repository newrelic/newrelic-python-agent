...
expected_message_ids_1 = [
    {
        ...
        "message_id": "chatcmpl-8TJ9dS50zgQM7XicE8PLnCyEihRug-0",
    },
    {
        "conversation_id": "my-awesome-id",
        "request_id": "f8d0f53b6881c5c0a3698e55f8f410ac",
        "message_id": "chatcmpl-8TJ9dS50zgQM7XicE8PLnCyEihRug-1",
    },
    {
        "conversation_id": "my-awesome-id",
        "request_id": "f8d0f53b6881c5c0a3698e55f8f410ac",
        "message_id": "chatcmpl-8TJ9dS50zgQM7XicE8PLnCyEihRug-2",
    },
]
...
expected_message_ids_2 = [
    {
        "conversation_id": "my-awesome-id",
        "request_id": "f8d0f53b6881c5c0a3698e55f8f410cd",
...
def test_get_llm_message_ids_mulitple_async(loop, set_trace_info, async_openai_client):
    ...
    async def _run():
        ...
        res2 = await async_openai_client.chat.completions.create(
...
@reset_core_stats_engine()
@background_task()
def test_get_llm_message_ids_mulitple_async_no_conversation_id(loop, set_trace_info, async_openai_client):
    set_trace_info()
...
@validate_custom_event_count(11)
@background_task()
def test_get_llm_message_ids_mulitple_sync_no_conversation_id(set_trace_info, sync_openai_client):
    set_trace_info()
