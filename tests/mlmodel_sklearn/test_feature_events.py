...
def test_ml_event_capture_disabled():
    @validate_custom_event_count(count=0)
    @background_task()
    def _test():
        import sklearn.tree

        x_train = np.array([[654, 234], [623, 681]], dtype="int")
        y_train = np.array([234, 345], dtype="int")
        x_test = np.array([[854, 938], [238, 921]], dtype="int")
