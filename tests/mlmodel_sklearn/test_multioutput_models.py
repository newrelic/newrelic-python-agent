...
@pytest.mark.parametrize("multioutput_model_name", ["ClassifierChain", "MultiOutputClassifier", "RegressorChain"])
def test_model_methods_wrapped_in_function_trace(multioutput_model_name, run_multioutput_model):
