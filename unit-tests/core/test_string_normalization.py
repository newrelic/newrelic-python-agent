...
class TestStringNormalization(unittest.TestCase):
    def setUp(self):
        self.rule = NormalizationRule(match_expression = "[0-9]+", 
                                      replacement = "*", 
                                      ignore = False, 
                                      eval_order = 1, 
    ...
    def test_normalization_rule_should_initialize(self):
        self.assertEqual("[0-9]+", self.rule.match_expression)
        self.assertEqual("*", self.rule.replacement)
        self.assertEqual(False, self.rule.ignore)
        self.assertEqual(1, self.rule.eval_order)
    ...
    def test_normalizer_should_initialize_with_multiple_rules(self):
        rule0 = self.rule
        rule1 = NormalizationRule(match_expression = "/something else/", 
                                  replacement = "?", 
                                  ignore = False, 
                                  eval_order = 1, 
                                  terminate_chain = True, 
    ...
    def test_rule_without_replace_all(self):
        rule = NormalizationRule(match_expression = "[0-9]+", 
                                 replacement = "*", 
                                 ignore = False, 
                                 eval_order = 1, 
                                 terminate_chain = True, 
    ...
    def test_multiple_rules_are_applied_in_eval_order(self):
        rule0 = NormalizationRule(match_expression = "[0-9]+", 
                                  replacement = "foo", 
                                  ignore = False, 
                                  eval_order = 0,
                                  ...
                                  each_segment = False, 
                                  replace_all = True)
        rule1 = NormalizationRule(match_expression = "foo", 
                                  replacement = "bar",
                                  ignore = False, 
                                  eval_order = 1,
                                  terminate_chain = False, 
    ...
    def test_rule_on_each_segment(self):
        rule = NormalizationRule(match_expression = ".*",
                                 replacement = "X",
                                 ignore = False, 
                                 eval_order = 0,
                                 terminate_chain = False, 
    ...
    def test_rules_with_terminate_chain_without_match_expression(self):
        rule0 = NormalizationRule(match_expression = "python_is_seriously_awesome", 
                                  replacement = "foo", 
                                  ignore = False, 
                                  eval_order = 0,
                                  terminate_chain = True, 
                                  each_segment = False, 
                                  replace_all = True)
        rule1 = NormalizationRule(match_expression = "1515", 
                                  replacement = "bar",
                                  ignore = False, 
                                  eval_order = 1,
                                  terminate_chain = False, 
