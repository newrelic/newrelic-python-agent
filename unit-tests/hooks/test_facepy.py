...
def handler(environ, start_response):
    ...
    # Get posts
    print graph.get('cocacola')
    print graph.get('pepsi')
    print graph.get('newrelic')

    # Need the time delay of 1 sec otherwise collector throws away any metric
    # that is smaller than 1s.
